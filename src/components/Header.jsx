...
export default function Header({carrito, vaciarCarrito, incrementarCantidad, decrementarCantidad}) {

    // State Derivado
    const isEmpty = useMemo( () => carrito.length === 0, [carrito] )

    // Total a pagar
    const carritoTotal = useMemo( () => carrito.reduce((total, guitarra) => total + (guitarra.price * guitarra.quantity), 0), [carrito] )
                                        ...
                                        <tr key={guitarra.id}>
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    type="button"
                                                    onClick={ ()=> vaciarCarrito(guitarra.id) }
                                                >
                                                    X
                                                </button>
                                            </td>
